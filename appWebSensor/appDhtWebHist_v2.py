...
def getHistData (numSamples):
	curs.execute("SELECT * FROM sensorsData ORDER BY  tdata desc, ttime desc limit "+str(numSamples))
	data = curs.fetchall()
	dates = []
	times=[]
	temps = []
...
@app.route('/plot/temp')
def plot_temp():
	dates, times, temps, hums = getHistData(numSamples)
	ys = temps
	fig = Figure()
